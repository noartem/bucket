# noartem's Scoop Bucket

[![Tests](https://github.com/noartem/bucket/actions/workflows/ci.yml/badge.svg)](https://github.com/noartem/bucket/actions/workflows/ci.yml) [![Excavator](https://github.com/noartem/bucket/actions/workflows/excavator.yml/badge.svg)](https://github.com/noartem/bucket/actions/workflows/excavator.yml)
...
| Name | Description | Official site | Repository |
| --- | --- | --- | --- |
| [TwentyMate](https://github.com/noartem/twentymate) | 20-20-20 windows app | [twentymate GitHub](https://github.com/noartem/twentymate) | [noartem/twentymate](https://github.com/noartem/twentymate) |
| [T3 Code](https://t3.codes) | The open-source control plane for coding agents | [t3.codes](https://t3.codes) | [pingdotgg/t3code](https://github.com/pingdotgg/t3code) |
| [Fastpotify](https://github.com/crmne/fastpotify) | Spotify, native and fast. One lightweight Rust app for your whole library, local playback, and Spotify Connect. | [Fastpotify GitHub](https://github.com/crmne/fastpotify) | [crmne/fastpotify](https://github.com/crmne/fastpotify) |
